...
import (
	...
	"github.com/jetstack/paranoia/internal/client/acr"
	"github.com/jetstack/paranoia/internal/client/docker"
	"github.com/jetstack/paranoia/internal/client/ecr"
	"github.com/jetstack/paranoia/internal/client/fallback"
	"github.com/jetstack/paranoia/internal/client/gcr"
	"github.com/jetstack/paranoia/internal/client/ghcr"
	"github.com/jetstack/paranoia/internal/client/oci"
	"github.com/jetstack/paranoia/internal/client/quay"
...
type ClientHandler interface {
	...
	Login(ctx context.Context, imageName string) error
}
...
func (c *Client) Tags(ctx context.Context, imageURL string) ([]api.ImageTag, error) {
	...
	c.log.Infof("using client %q for image URL %q", client.Name(), imageURL)
